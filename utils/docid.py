...
def get_js(data):
    with open('utils/docid.js', 'r') as f:
        js_data = f.read()
...
if __name__ == '__main__':
    ...
    docid = "7Cu8Oxb1hzw6FJesOIwpnDqcK5w5ZlwqjDucOOwrMWw5DCscOAAh9kw4zCgRwecsKaf8OJw5jCi8O2w4d4Z0vChcOsF8KSw5LCp8OZAcKEfFVka8OgwoELNivDuwE="
